...
init_upload(MonitorIP, MonitorPort, File) ->
    ...
    case build_packet(File) of
        ...
        FilePacket ->
            ...
            {Filename, Hash, _Content} = parse_packet(FilePacket),
            ...
            case connect(MonitorIP, MonitorPort) of
                {ok, Socket} ->
                    ...
                    case Peers of 
                        [] -> 
                            io:format("There are no peers to accept uploads.~n");
                        _List -> 
...
init_download(MonitorIP, MonitorPort, File) ->
    ...
    case connect(MonitorIP, MonitorPort) of
        {ok, Socket} ->
            ...
            case Peers of 
                [] -> 
                    io:format("There are no peers to download from.~n");
                _List -> 
            ...
            % call helper fun to download File from every Peer in Peers
            %download(Hash, Peers, File);
        {error, _} -> io:format("You cannot connect to the monitor at this time.~n")
    end.
...
%%
download_from_peer([], _Packet, _Filename) -> 0;
            ...
            case RetVal of
                ...
                _File -> 
                    ...
                    case Success of
                        ...
                        {error, _} -> io:format("Error when writing file.~n")
                    end
            end;

...
%%
open_packet(_Socket, {join, ClientNode, ClientServPid, ClientIP, ClientPort}) ->
...
%%
open_packet(_Socket, {logout, ClientNode, ClientServPid}) ->
    MonitorListener = whereis(listener),
...
%%
open_packet(Socket, {upload, ClientNode, _ClientServPid, _Hash, ClientIP}) ->
...
%%
open_packet(Socket, {download, ClientNode, _ClientServPid, _Hash, ClientIP}) ->
    Peers = lookup_peers(ClientNode, ClientIP),
